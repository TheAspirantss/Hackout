...
app.get("/event/:eventId", async (req, res) => {
  ...
  try {
    ...
    res.render("customevent", { selectedEvent, userId });
  } catch (error) {
    console.error(error);
...
app.post("/regevents/:userId" , async (req,res) =>{
  ...
  try {
    ...
    const sub = "Registration Successfull!";
    const msg =
      "Dear " + userName + " You have Successfully registreted on event.";
